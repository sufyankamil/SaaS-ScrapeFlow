...
const routes = [{
    ...
    name: 'WorkFlows', href: "workflows", icon: Layers2Icon,
}, {
    name: 'Credentials', href: "credentials", icon: ShieldCheckIcon,
}, {
    name: 'Billing', href: "billing", icon: CoinsIcon,
}];
    ...
    return (<div
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex flex-col p-2">
                {routes.map((route, index) => (<a key={index}
                                                  href={`/${route.href}`}
